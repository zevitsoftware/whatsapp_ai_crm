...
- `backend/src/models/chat_log.js`
- `backend/src/services/reply.worker.js`
- `backend/src/services/reply.queue.js`
- `backend/src/models/contact.js`
- `backend/src/services/ai.service.js`
- `backend/src/services/vector.service.js`
- `backend/src/services/reply.service.js`
...
**Status**: **Conversational AI Core logic is [COMPLETED]**
